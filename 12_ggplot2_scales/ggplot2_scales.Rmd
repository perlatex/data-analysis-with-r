...
```{r}
# label_comma() and label_dollar() are special version of label_number()

scales::label_comma()(20^(1:3))
scales::label_dollar()(c(-1000, -100, 100, 1000))
scales::label_percent()(c(0.4, 0.6))
scales::label_percent(scale = 1)(c(50, 55))
```
...
gapminder %>% 
  ggplot(aes(gdpPercap, y = lifeExp, color = continent)) +
  geom_point() +
  guides(color = "none") +
  scale_x_log10()
