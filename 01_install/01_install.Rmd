...
1. 按住 `Ctrl` 键，然后按回车键`Enter`，可以运行**光标所在行**的代码
2. 点击 `Run`, 运行**光标所在行**的代码
3. 点击 `Source`，从头到尾运行当前脚本**全部**代码
4. 鼠标选中多行代码，然后点击 `Run`或者`Ctrl + Enter`
...
这是你电脑开机用户名是中文导致的，建议使用英文注册一个新用户，在新用户名下，重新安装R和Rstudio
